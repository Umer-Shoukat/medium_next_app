...
const styles = {
  ...
  postHeaderContent: `flex justify-between items-center mt-[2.2rem] mb-[1.2rem]`,
  authorContainer: `flex gap-[1rem]`,
  authorProfileImageContainer: `h-[3rem] w-[3rem] grif center rounded-full overflow-hidden`,
  image: `object-cover`,
